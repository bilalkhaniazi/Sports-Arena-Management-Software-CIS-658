...
import { getDefaultRouteForRole, setStoredUser } from "../../utils/auth";
...
const SignIn: React.FC = () => {
    ...
    const loginMutation = useMutation({
      ...
      onSuccess: (data) => {
          ...
          navigate(getDefaultRouteForRole(data.user.role ?? "customer")); 
      },
      onError: (error) => {
          console.error(error);
          toast.error(
            getAxiosErrorMessage(error, {
              noResponse:
                "Cannot reach the server. Start the backend (port 5000) and ensure MySQL is running.",
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block" src={Logo} alt="Logo" width={250}/>
                <img className="dark:hidden" src={LogoDark} alt="Logo" width={250}/>
              </Link>

              <p className="2xl:px-20">
              Manage and track all your bookings efficiently with Cross Courts' powerful admin dashboard.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Streamline your booking management process with</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to Cross Courts
              </h2>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="mb-5">
                   ...
                   <button
                        ...
                        disabled={loginMutation.isPending} // Disable button when logging in
                    >
